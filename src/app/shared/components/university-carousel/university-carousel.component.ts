...
export class UniversityCarouselComponent implements AfterViewInit, OnDestroy {
  ...
  private readonly baseUniversities: University[] = [
    ...
    //{ name: 'Instituto Superior Técnico da Universidade de Lisboa', logo: 'https://upload.wikimedia.org/wikipedia/en/2/20/Instituto_Superior_T%C3%A9cnico_logo.png', url: 'https://tecnico.ulisboa.pt/pt/' },
    { name: 'Politécnico do Cávado e do Ave', logo: 'https://idp.ipca.pt/idp/FCCN/images/ipca.pt.png', url: 'https://www.ipca.pt' },
